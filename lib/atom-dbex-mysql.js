...
`;
  ...
  stopQuery(uuid, connData) {
    let queryToStop = this.uuids[uuid];
    let query = `
SELECT *
...
//   refreshNode(connectionName, datasets, onSuccess) {
//     console.log('refreshNode on engine', connectionName, datasets);
//     let connection = this.connections[connectionName];  //TODO: properly get connection or connect if still not
//
//     if (datasets.table) {
//       this._getTableNode(
//         connection,
//         datasets.table.split('.').pop(),
//         onSuccess,
//         onSuccess
//       );
//     }
//
//     // _getNode(connection, query, onSuccess, onSuccess);
//   }
//
//   _getTableNode(connection, table, resolve) {
//     let query = `
//   SELECT *
//     FROM INFORMATION_SCHEMA.COLUMNS
//    WHERE TABLE_NAME = '${table}'
// ORDER BY TABLE_SCHEMA, TABLE_NAME, FIELD(COLUMN_KEY, 'PRI', 'UNI', 'MUL', '') ASC, ORDINAL_POSITION
// `;
//
//     this.logger.log('getNode', query);
//
//     connection.query(query, (err, results, fields) => {
//       if (err) {
//         console.log("query failed", err)
