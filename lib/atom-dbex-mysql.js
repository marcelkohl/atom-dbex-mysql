...
export default class DbexMySQL {
   ...
   */
  getName() {
    return "mysql-marcelkohl"; //  Be creative to not get conflicted by other author's names
  }
    ...
    databases.forEach((record)=>{
      result.push(
        new TreeItem({
          ...
          classes: ['mysql-table-counter-detail'], // optional custom style classes to be added to the node
